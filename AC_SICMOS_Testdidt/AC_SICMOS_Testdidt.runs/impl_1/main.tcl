...
set rc [catch {
  ...
  set_param synth.incrementalSynthesisCache ./.Xil/Vivado-3381-szn-thinkpad/incrSyn
  ...
  add_files -quiet /home/zenanshi/ZYNQStation/AC_SICMOS_Testdidt/AC_SICMOS_Testdidt.runs/synth_1/main.dcp
